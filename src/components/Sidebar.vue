  ...
  >
        ...
        >
          <div
            ...
            :class="{
              ...
              'translate-x-0': isActive('/dashboard') && !isExpand,
            }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <div
            ...
            :class="{
              ...
              'translate-x-0': isActive('/chat') && !isExpand,
            }"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <span :hidden="!isExpand" class="ms-2">
        ...
        <p class="text-slate-700/80 text-md">{{ useAuth.username }}</p>
      </span>
      <svg
        @click="handleLogout"
        xmlns="http://www.w3.org/2000/svg"
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="size-6 cursor-pointer text-red-500/80 my-auto ms-auto"
      >
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
