...
const handleExpand = () => {
  emit("toggle", !isExpand.value);
  isExpand.value = !isExpand.value;
};
</script>

<template>
  <div class="py-4 px-6 bg-mainblue h-screen flex flex-col">
    ...
    <div class="py-3 flex-1 overflow-y-auto">
      ...
      <ul class="text-md mt-4 space-y-1.5">
        <li
          class="flex gap-2 items-center bg-blue-500 p-2 cursor-pointer rounded-xl justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <p
            class="text-white font-semibold hidden"
            :class="{
        ...
        <li
          class="flex gap-2 items-center hover:bg-slate-200/70 hover:rounded-xl p-2 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
          ...
          <p
            class="text-slate-700/80 font-semibold hidden"
            :class="{
              'inline-block': isExpand,
              hidden: !isExpand,
            }"
    ...
    >
      ...
      <span :hidden="!isExpand" class="ms-2">
        <p class="font-bold text-black text-md">Administrator</p>
        <p class="text-slate-700/80 text-md">Administrator</p>
      </span>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="size-5 text-black/80 my-auto ms-auto"
      >
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
